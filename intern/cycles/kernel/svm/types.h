...
#define CLOSURE_IS_REFLECTION(type) \
  (type == CLOSURE_BSDF_MICROFACET_BECKMANN_ID || type == CLOSURE_BSDF_MICROFACET_GGX_ID)
#define CLOSURE_IS_SMS_COMPATIBLE(type) \
  (CLOSURE_IS_REFLECTION(type) || CLOSURE_IS_REFRACTION(type) || CLOSURE_IS_GLASS(type))
